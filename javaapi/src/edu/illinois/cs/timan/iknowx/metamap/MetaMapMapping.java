...
public class MetaMapMapping {
	...
	public static Map<String, String> getMapping(String threadId, String jsonDir) throws Exception {
		MetaMapPost mFirstPost = MetaMapIO.loadPostFromJson(threadId, jsonDir);
		Map<String, String> mapping = new HashMap<String, String>();
