...
public class BaselineForumCV extends CV {
	...
	public static void main(String[] args) throws Exception {		
		...
		for (int fold = 0; fold < folds.size(); ++fold) {
			...
			CombinedFeatures.saveFeatures(trainSet, nFeatures, Constants.fourClassTrain + fold);
			List<String> testTids = CombinedFeatures.saveFeatures(testSet, nFeatures, Constants.fourClassTest + fold);
