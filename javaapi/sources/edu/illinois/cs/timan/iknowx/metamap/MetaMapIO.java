...
public class MetaMapIO {
	...
	public static MetaMapPost loadPostFromJson(String threadId) throws Exception {
		String filename = Constants.postJsonDir + threadId + ".json";
	...
	public static void main(String[] args) throws Exception {
		...
		List<MetaMapPost> list = new ArrayList<MetaMapPost>();
